...
const Footer = () => {
      ...
      socialLinks: [
        {
          ...
          link: "https://www.facebook.com/profile.php?id=61555629786554",
        },
        { Icon: <YouTube />, link: "http://www.youtube.com/@KhurramZarai" },
        {
          Icon: <Instagram />,
          link: "https://www.instagram.com/khurramzarai/",
        },
      ],
    },
    {
  ...
  return (
    <>
      <Box
        paddingTop="6rem"
        className="grid grid-cols-2 md:grid-cols-4 gap-12  px-16 md:pl-96"
